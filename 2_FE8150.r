...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , tot_prestamos           := rowSums( cbind(mprestamos_personales, mprestamos_prendarios , mprestamos_hipotecarios), na.rm=TRUE) ]
  dataset[ , prestamos_saldo         := tot_prestamos  / mcuentas_saldo ]
...
#grabo el dataset
fwrite( dataset,
        "dataset_8150_ajusteIPCTC.csv.gz",
        logical01= TRUE,
        sep= "," )
